...
@Component({
  selector: 'query-weather',
  templateUrl: './query.weather.html',
  styleUrls: ['./query.weather.css']
})
export class QueryWeatherComponent extends AbstractComponent{
